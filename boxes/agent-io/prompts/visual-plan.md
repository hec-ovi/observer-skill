...
- It needs invented data. Never draw numbers the video did not give and your research did
  ...
  that screen. If the shape matters and the values do not exist, draw the shape and label
  the axes qualitatively, and say in the caption that the values are illustrative.
