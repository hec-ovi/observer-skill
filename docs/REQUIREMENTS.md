...
Every request from Hector, raw and in the order it arrived. Nothing here is rewritten.

## 2026-08-05, first dump
...
## 2026-08-05, follow-ups

> read the whole requirements in docs folder, then do the topics, description, readme then make a deep architecture of the plan and needed steps to finish end to end the MCP with the toolkit and the frontend of it

> the repo is created in observer-skill as well so you can initialize it there
